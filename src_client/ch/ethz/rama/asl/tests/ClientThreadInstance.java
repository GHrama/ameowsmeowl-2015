...
public class ClientThreadInstance implements Runnable {
	...
	public void run() {
		...
		clientlogger.info("Client thread started with id :: "+client_id);
		...
		while(System.currentTimeMillis() < endTime)
		{
			...
			clientlogger.info("Client with id"+client_id+"requestTime for SEND_MSG ::"+(endrequestTime-startrequestTime));
			...
			clientlogger.info("Client with id"+client_id+"requestTime for GET_QUEUE  ::"+(endrequestTime-startrequestTime));
			...
			clientlogger.info("Client with id"+client_id+"requestTime for GET_LATEST_MSG_DELETE  ::"+(endrequestTime-startrequestTime));
