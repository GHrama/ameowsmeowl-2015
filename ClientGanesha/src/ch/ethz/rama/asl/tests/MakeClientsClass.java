...
//		int number_queues = 5;
//		int number_clients = 10; // number fo clients per machine
...
//		logger.addHandler(handler);
		...
		for(int i=0; i < number_clients; i++){
			...
			logger.info("Client number = "+((i+1)+((number_machines-1)*number_clients)));
			int cc = ((i+1)+((number_machines-1)*number_clients));
			ClientThreadInstance c1 = new ClientThreadInstance(machine_id,cc,number_queues,number_clients,duration_experiment,message_length,number_machines);
