...
public class ClientThreadInstance implements Runnable {
	...
	ClientThreadInstance(int machine_id,int client_id,int number_queues,int number_clients,int duration,int msg_size,int number_machines){
	...
	public void run() {
		...
		while(System.currentTimeMillis() < endTime)
		{
			...
			int random_queue = magic.nextInt(number_of_queues_in_system)+1; 
