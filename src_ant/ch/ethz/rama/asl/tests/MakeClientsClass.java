...
public class MakeClientsClass {
	...
	public static void main(String args[]) throws InterruptedException{
		...
		for(int i=0;i<number_queues;i++){
			String queue_name="queue::"+i+"of machine::"+machine_id;
			int q1 = dummy_instance.addQueue(queue_name);
			System.out.println("cretaed queue::"+i+"machine:"+machine_id+"DB queue number::"+q1);
			
		}
		
		// wait till all queues have been created on al machines
		Thread.sleep(5000);
		...
		for(int i=0; i<number_clients;i++){
			...
			ClientThreadInstance c1 = new ClientThreadInstance(i*number_machines,number_queues,number_clients,duration_experiment,message_length);
